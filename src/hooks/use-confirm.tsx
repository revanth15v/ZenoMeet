	...
	const ConfirmationDialog = () => (
		<ResponsiveDialog open={promise !== null} onOpenChange={handleClose} title={title} description={description}>
			<div className="pt-4 w-full flex flex-col-reverse gap-y-2 lg:flex-row gap-x-2 items-center justify-end">
				<Button onClick={handleCancel} variant="outline" className="w-full cursor-pointer lg:w-auto">
					Cancel
				</Button>
				<Button onClick={handleConfirm} className="w-full cursor-pointer lg:w-auto">
					Confirm
				</Button>
			</div>
		</ResponsiveDialog>
