          ...
          <CardContent className="grid p-0 lg:grid-cols-2 min-h-[700px]">
                ...
                >
                  ...
                  <div ref={buttonsRef} className="space-y-4">
                    <Button
                      disabled={pending}
                      type="submit"
                      className="w-full h-12 bg-gradient-to-r cursor-pointer from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 text-white font-semibold transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {pending ? (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center p-12 text-center text-white">
                ...
                <h2 className="text-4xl font-bold mb-4">ZenoMeet</h2>
                <p className="text-xl text-emerald-100 mb-8 max-w-md">
                  Where collaboration meets intelligence.
ZenoMeet lets you host smarter meetings with AI agents that adapt to your workflow.
                </p>
